...
// node_modules/vitest-browser-react/dist/chunk-B4RPINYK.js
...
function renderHook(renderCallback, options = {}) {
  ...
  const { rerender: baseRerender, unmount } = render(
    import_react.default.createElement(TestComponent, { renderCallbackProps: initialProps }),
    renderOptions
  );
  function rerender(rerenderCallbackProps) {
    return baseRerender(
      import_react.default.createElement(TestComponent, { renderCallbackProps: rerenderCallbackProps })
    );
  }
